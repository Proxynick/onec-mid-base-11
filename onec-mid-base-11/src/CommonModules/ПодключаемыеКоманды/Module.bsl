...
Процедура ДобавитьКнопкуРсчетаСкидки(Форма)
	
	НоваяКоманда = Форма.Команды.Добавить("ПересчитатьСкидку");
	НоваяКоманда.Действие = "ПересчитатьСуммуСУчетомСкидки";//Имя процедуры
	НоваяКоманда.Заголовок = "Пересчитать скидку";

	НоваяКнопка = Форма.Элементы.Добавить("ПересчитатьСкидку", Тип("КнопкаФормы"), Форма.Элементы.ГруппаШапкаЛево);
